# Code of Conduct - multicz-action Project

## Our Pledge

We pledge to make the **multicz-action** project a welcoming, safe, and equitable space for all contributors and users.
...
As part of the development, documentation, research, and dissemination of results related to **multicz-action**, we strive to:
